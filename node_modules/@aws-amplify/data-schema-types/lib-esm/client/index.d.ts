...
type ModelTypesClient<Model extends Record<string, unknown>, ModelMeta extends ModelMetaShape> = IndexQueryMethodsFromIR<ModelMeta['secondaryIndexes'], Model> & {
...
type ModelTypesSSRCookies<Model extends Record<string, unknown>, ModelMeta extends ModelMetaShape> = IndexQueryMethodsFromIR<ModelMeta['secondaryIndexes'], Model> & {
    create: (model: Prettify<CreateModelInput<Model, ModelMeta>>, options?: {
        authMode?: AuthMode;
        authToken?: string;
        headers?: CustomHeaders;
...
type ModelTypesSSRRequest<Model extends Record<string, unknown>, ModelMeta extends ModelMetaShape> = IndexQueryMethodsFromIR<ModelMeta['secondaryIndexes'], Model> & {
